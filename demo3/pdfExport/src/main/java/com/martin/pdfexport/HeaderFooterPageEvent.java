...
public class HeaderFooterPageEvent extends PdfPageEventHelper {
    ...
    public void onOpenDocument(PdfWriter writer, Document document) {
        ...
        try {
            ...
            font = BaseFont.createFont(fontfilePath, BaseFont.WINANSI,
                    BaseFont.EMBEDDED);
    ...
    static SimpleDateFormat  dateformate=new SimpleDateFormat("EEEEEEEEE, MMMMMMM dd, yyyy hh:mm:ss a");
    // begin to init table
    private static PdfPTable addRWtitleTable() {
        ...
        cell.addElement(new Chunk("Ver# 2.00                            ID# 123", thirdtitleFont));
